...
const artistdata = new artistlist(
  [
    ...
    new Artist(
      ...
      'he/him',
      [
        new Work(0, 'image','/works/s-l1600.jpg'),
        new Work(0, 'image','/works/71w2KeTHRKL._AC_SL1200_.jpg'),
        new Work(0, 'image','/works/138399600-bronze-sculpture-of-children-in-the-square-eastern-europe-kiev.jpg'),
        new Work(0, 'image','/works/vigeland-Park-oslo-little-boy-crying.jpg')
      ],
    ...
    new Artist(
      ...
      'she/her',
      [
        new Work(0, 'image','/works/Untitled-3.png-1-520x400.jpg'),
        new Work(0, 'image','/works/b77ae5e7-88e0-4b46-9baf-40998242c20f.jpg'),
        new Work(0, 'image','/works/Chernobyl---The-Aftermath-015.jpg'),
        new Work(0, 'image','/works/c017.jpg'),
      ],
    ...
    new Artist(
      ...
      'he/him',
      [
        new Work(0, 'image','/works/50-incredible-3d-logo-design-examples-for-inspiration-cover.png'),
        new Work(0, 'image','/works/attachment_89914782.png'),
        new Work(0, 'image','/works/Shiny.jpg'),
        new Work(0, 'image','/works/ribbion.jpg'),
      ],
    ...
    new Artist(
      ...
      'none',
      [
        new Work(0, 'image','/works/151279218-ai-robot-cyberpunk-style-bionic-automatic-face-futuristic-technology-network-server-online-backgroun.jpg'),
        new Work(0, 'image','/works/gas-mask-5543894_960_720.jpg'),
        new Work(0, 'image','/works/SCG_0021_Layer-1.jpg'),
        new Work(0, 'image','/works/tsvet-stil-fantasy-style-color-fantastika-fiction-illustra-1.jpg'),
      ],
    ...
    new Artist(
      ...
      'she/they',
      [
        new Work(0, 'image','/works/adipocere-03.jpg'),
        new Work(0, 'image','/works/Trolleyed-525x525mm.jpg'),
        new Work(0, 'image','/works/960x0.jpg'),
        new Work(0, 'image','/works/adipocere_beautifulbizarre_001.jpg'),
      ],
    ...
    new Artist(
      ...
      'she/her',
      [
        new Work(0, 'image','/works/Backchannel-Uyghur-TikTok.jpg'),
        new Work(0, 'image','/works/Hsu-AsianAmerican.jpg'),
        new Work(0, 'image','/works/gettyimages-165904997-1024x1024.jpg'),
        new Work(0, 'image','/works/564fb56994af4bbdbbf0a769f85f5a5f.jpeg'),
      ],
    ...
    new Artist(
      ...
      'she/her',
      [
        new Work(0, 'image','/works/s-l640.jpg'),
        new Work(0, 'image','/works/River2web.jpg'),
        new Work(0, 'image','/works/806_2397_articles.jpg'),
        new Work(0, 'image','/works/arghael-main-235a859f.jpeg'),
      ],
    ...
    new Artist(
      ...
      'he/him',
      [
        new Work(0, 'image','/works/180704154929-yugoslavia-architecture.jpg'),
        new Work(0, 'image','/works/2019-04-17-OpticaBasanta-020.jpg'),
        new Work(0, 'image','/works/SOSNO83850-hires-1024x718.jpg'),
        new Work(0, 'image','/works/restaurant_minsk_potsdam.jpg'),
      ],
    ...
    new Artist(
      ...
      'they/them',
      [
        new Work(0, 'image','/works/badass-tattoos-2.jpg'),
        new Work(0, 'image','/works/49773553a4cba7a804851a6a7afd0588.jpg'),
        new Work(0, 'image','/works/561d3f6bce3ba65bf51887de034b6587.jpg'),
        new Work(0, 'image','/works/xmLPhXM.jpeg'),
      ],
    ...
    new Artist(
      ...
      'she/her',
      [
        new Work(0, 'soundcloud','https://soundcloud.com/toilet-ov-hell/merzbow-feat-pitbull-give-me-pulse-demon-tonight'),
        new Work(0, 'soundcloud','https://soundcloud.com/noisey/dj-george-costanza-country-rap-mix'),
        new Work(0, 'soundcloud','https://soundcloud.com/booty-master/every-drop-on-recess-at-once')
      ],
    ...
    new Artist(
      ...
      'he/him',
      [
        new Work(0, 'youtube','https://www.youtube.com/watch?v=IZ0WrPG9PTg')
      ],
    ...
    new Artist(
      ...
      'she/her',
      [
        new Work(0, 'image','/works/urn_cambridge.org_id_binary_20200813122209779-0803_S0149767720000145_S0149767720000145_fig1.png'),
        new Work(0, 'image','/works/ShostakovichTrilogy_FrancesChung_Header.jpg'),
        new Work(0, 'image','/works/DU19-Hocus-Pocus-Philippe-Saire.-Photo-Philippe-Pache-2-1-1170x600.jpg'),
        new Work(0, 'image','/works/2-280979-Main-900x556-8.jpg'),
      ],
    ...
    new Artist(
      ...
      'they/them',
      [
        new Work(0, 'image','/works/panopticon-invert-1.jpg'),
        new Work(0, 'image','/works/Giselle-Stanborough_2020_03_23-015--1140x641.jpeg'),
        new Work(0, 'image','/works/187-julia-scher.jpg'),
        new Work(0, 'image','/works/gettyimages-606073410-612x612.jpg'),
      ],
